# Requirements Archive: v6.0 Karar Güvenliği & Sistem Olgunlaşması
...
- [x] **VERI-01**: Hisse listesi ve hisse kartlarında son fiyat güncelleme zamanı gösterilir
- [x] **VERI-02**: Hisse detay sayfasında fundamental veri dönemi etiketi gösterilir (ör. "2024-Q3")
- [x] **VERI-03**: 8 saatten eski fiyat verisi için görsel uyarı gösterilir
- [x] **VERI-04**: AI analizinin altına hangi veri tarihine dayandığı notu eklenir

### Portföy Risk Yönetimi (RISK)

- [x] **RISK-01**: Portföy sayfasında sektör dağılımı görselleştirmesi gösterilir
- [x] **RISK-02**: Tek sektör ağırlığı >%35 olduğunda yoğunlaşma uyarısı görünür
- [x] **RISK-03**: Tek hisse ağırlığı >%20 olduğunda yoğunlaşma uyarısı görünür
- [x] **RISK-04**: Portföy özet kartına toplam pozisyon sayısı ve en büyük 3 sektör bilgisi eklenir

### İşlem Disiplini & Günlüğü (GUNLUK)

- [x] **GUNLUK-01**: Pozisyon formuna "kararı bozan koşul" metin alanı eklenir
- [x] **GUNLUK-02**: Pozisyon kapatılırken çıkış nedeni seçimi eklenir: Stop Tetiklendi / Hedefe Ulaştı / Senaryo Bozuldu / Diğer
- [x] **GUNLUK-03**: Kapalı pozisyonlar listesinde giriş gerekçesi ve çıkış nedeni görünür
- [x] **GUNLUK-04**: Portfolio sayfasında kapalı pozisyon istatistiği: toplam kapatılan, ortalama K/Z, planlı çıkış oranı
...
| GUNLUK-03 | Phase 47 | Complete |
| GUNLUK-04 | Phase 47 | Complete |
