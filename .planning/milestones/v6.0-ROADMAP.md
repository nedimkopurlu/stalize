...
Plans:
- [ ] 47-01-PLAN.md — Backend model + Alembic migration (007) + endpoint güncellemeleri (GUNLUK-01, GUNLUK-02)
- [ ] 47-02-PLAN.md — api.ts interface + PositionForm + closeForm + handler güncellemeleri (GUNLUK-01, GUNLUK-02)
- [ ] 47-03-PLAN.md — Kapalı pozisyon UI: rationale italik + exit badge + stats bar + CSS (GUNLUK-03, GUNLUK-04)
...
| 47. İşlem Disiplini & Günlüğü | v6.0 | `/portfolio` + backend | 0/3 | ⬜ Planned | — |
