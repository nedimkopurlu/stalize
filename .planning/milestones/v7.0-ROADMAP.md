...
Plans:
- [x] 48-01-PLAN.md — DB migration 008 + calculate_data_quality_score + API serialization (VKL-01, VKL-02)
- [x] 48-02-PLAN.md — safeLabel consolidation into StockHelpers.tsx; 3 pages updated (TECH-01)
- [x] 48-03-PLAN.md — Frontend quality badge (stocks list) + Veri Güven Skoru row (detail page) (VKL-01, VKL-02)
...
- [x] 54-02-PLAN.md — Frontend: api.ts type güncellemeleri, rejim kırılım tablosu, rejim filtresi, slipaj KPI kartı
...
- [x] 55-02-PLAN.md — Pre-trade checklist modal, "Pozisyon Aç" butonu, 7 auto-populated madde (UI-02)
