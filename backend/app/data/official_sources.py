...
OFFICIAL_SOURCE_CATALOG: List[Dict[str, str]] = [
    ...
    {"key": "tefas", "name": "TEFAS", "url": "https://www.tefas.gov.tr", "category": "funds", "ingest_status": "planned", "priority": "tier2", "scan_mode": "on_demand", "cadence": "external_endpoint_disabled", "warn_after_hours": "168", "status_note": "TEFAS toplu fon evreni endpointi resmi tarafta devre dışı; fon detayları on-demand izleniyor", "api_endpoint": "/api/sources/tefas/universe"},
]
